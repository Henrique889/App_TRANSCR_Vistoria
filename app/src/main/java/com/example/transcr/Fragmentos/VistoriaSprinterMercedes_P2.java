...
public class VistoriaSprinterMercedes_P2 extends AppCompatActivity {
    ...
    TextView viewCarrinho, viewcatracaM,viewCalotas, viewCordas, viewCinta, viewqtsChaves, viewKitG, viewKitP,
            viewChavePonta,viewChaveDupla,viewChaveBoca,viewPino;
    EditText campoCarrinho, campoqtsChaves, campoKitG,campocatracaM, campoKitP,txtChavePonta,txtChaveDupla,
            txtChaveBoca,campoCalotas,txtPino;
    ...
    public VistoriaSprinterMercedes_P2() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scrollfichasprinter_mercedes2);

        // Inflate the layout for this fragment
        placaVeiculo = findViewById(R.id.placa2 );
        btn = findViewById(R.id.button2);
        btnAdicionar = findViewById(R.id.btnAdicione);

        Calendar calendar = Calendar.getInstance();
        String currentDate = DateFormat.getDateInstance().format(calendar.getTime());
        textViewDate = findViewById(R.id.txt_date4);
        textViewDate.setText(currentDate);

        campoCarrinho = findViewById( R.id.campoCarrinho);
        campocatracaM = findViewById(R.id.campoCatraca_Movel);
        ...
        txtChavePonta= findViewById( R.id.campoChaveDT );
        txtChaveDupla= findViewById( R.id.campoChaveFendaP);
        txtChaveBoca= findViewById( R.id.campoChaveBoca );
        txtPino = findViewById(R.id.campoPino);

        viewcatracaM = findViewById( R.id.viewCatraca_M);
        ...
        viewChavePonta = findViewById( R.id.viewChaveDT);
        viewChaveDupla = findViewById( R.id.viewChaveFendaP);
        viewChaveBoca = findViewById( R.id.viewChaveBoca);
        viewPino = findViewById( R.id.viewPino);

        spLampadasD = findViewById( R.id.spLampadaD);
        spLampadasL = findViewById( R.id.spLampadaL);
        spLampadasT = findViewById( R.id.spLampadaT);
        spInterior = findViewById( R.id.spInterior2);
        ...
        jsonObjectReq = new JsonObjectRequest( Request.Method.GET, url, null, new Response.Listener <JSONObject>() {
            ...
            public void onResponse ( JSONObject response ) {
                ...
                try{
                    ...
                    tabFicha.setcatracaMovel( jsonObject.optString("Catracas_M"));
                    ...
                    tabFicha.setChaveDupla( jsonObject.optString("chavePonta"));
                    tabFicha.setChaveFenda( jsonObject.optString("chaveDuplaFenda"));
                    tabFicha.setChaveBoca( jsonObject.optString("chaveBoca"));
                    tabFicha.setPino( jsonObject.optString("pino"));

                }catch (JSONException e) {
                    e.printStackTrace();
                }

                viewcatracaM.setText(tabFicha.getcatracaMovel());
                ...
                viewChavePonta.setText(tabFicha.getChaveDupla());
                viewChaveDupla.setText(tabFicha.getChaveFenda());
                viewChaveBoca.setText(tabFicha.getChaveBoca());
                viewPino.setText(tabFicha.getPino());
    ...
    private void carregarWebService1 () {
        ...
        String ip = getString( R.string.ip2 );
        String url = ip + "/webservice/cadastro_VistoriaSprinterA.php?";
        stringRequest = new StringRequest( Request.Method.POST, url, new Response.Listener <String>() {
            ...
            public void onResponse ( String response ) {
                ...
                if (response.trim().equalsIgnoreCase( "registra" )) {
                    ...
                    campoKitG.setText("");
                    campoKitP.setText("");
                    txtChaveDupla.setText("");
                    txtChavePonta.setText("");
                    txtChaveBoca.setText("");
                    txtPino.setText("");
            ...
            protected Map <String, String> getParams () throws AuthFailureError {
                ...
                String tapetes = bundle.getString("Seventeen");
                String catracas = bundle.getString("Eighteen");
                String catracaMovel = campocatracaM.getText().toString();
                String cordas = bundle.getString("Nineteen");
                String cinta = bundle.getString("Twenty");
                ...
                String chavePontaDT = txtChavePonta.getText().toString();
                String chaveFenda = txtChaveDupla.getText().toString();
                String chaveBoca = txtChaveBoca.getText().toString();
                ...
                params.put( "Catracas_M", catracaMovel );
                ...
                params.put( "ChaveTorxDupla", chavePontaDT );
                params.put( "ChaveFenda", chaveFenda );
                params.put( "ChaveBoca", chaveBoca );
        ...
        email.putExtra(android.content.Intent.EXTRA_TEXT,"Placa Veículo: "+placaVeiculo.getText().toString()+", Nome: "+
                ...
                ", Tapetes: "+bundle.getString("Seventeen").toString()+ ", Catracas: "+bundle.getString("Eighteen").toString()+
                ", Catracas Móveis: "+campocatracaM.getText().toString()+", Cordas: "+bundle.getString("Nineteen").toString()+
                ", Cinta: "+bundle.getString("Twenty").toString()+", Qts de Chaves: "+campoqtsChaves.getText().toString()+
                ", Chave de Torx Dupla: "+txtChavePonta.getText().toString()+", Chave de Fenda Dupla: "+txtChaveDupla.getText().toString()+
                ", Chave de Boca: "+txtChaveBoca.getText().toString()+", Pino de Reboque: "+txtPino.getText().toString()+
