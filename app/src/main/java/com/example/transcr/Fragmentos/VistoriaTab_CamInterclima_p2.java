...
public class VistoriaTab_CamInterclima_p2 extends AppCompatActivity {
    ...
    TextView viewChaveRodas,viewTacografo,viewTapetes, viewcaboAco, viewCatracas, viewcatracaM, viewCordas, viewCinta, viewqtsChaves, viewLanterna, viewKitG, viewKitP,viewInterclima;
    EditText campoChaveRodas, campoTacografo, campoTapetes, campocaboAco, campoCatracas,
            campocatracaM, campoCordas, campoCinta, campoqtsChaves, campoLanterna, campoKitG, campoKitP,campoInterclima;
    ...
    public VistoriaTab_CamInterclima_p2() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scrollfichacaminhao_p2);
        ...
        textViewDate = findViewById(R.id.txt_date5);
        ...
        spLampadasD = findViewById( R.id.spLamD);
        spLampadasL = findViewById( R.id.spLamL);
        spLampadasT = findViewById( R.id.spLamT);
        spInterior = findViewById( R.id.spInteriorl);
        ...
        jsonObjectReq = new JsonObjectRequest( Request.Method.GET, url, null, new Response.Listener <JSONObject>() {
            ...
            public void onResponse ( JSONObject response ) {
                ...
                try{
                    ...
                    tabFicha.setcatracaMovel( jsonObject.optString("catracaMovel"));
    ...
    private void carregarWebService1 () {
        ...
        String ip = getString( R.string.ip2 );
        String url = ip + "/webservice/cadastro_VistoriaB.php?";
        stringRequest = new StringRequest( Request.Method.POST, url, new Response.Listener <String>() {
            ...
            protected Map <String, String> getParams () throws AuthFailureError {
                ...
                String ChaveFixa =  bundle.getString("Sixteen");
                ...
                params.put( "ChaveFixa", ChaveFixa );
