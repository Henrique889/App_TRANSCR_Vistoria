...
public class VistoriaTab_CamInterclima_p1 extends Fragment {
    ...
    TextView viewExtintor, viewCapaChuva, viewRadio, viewAntena,viewLona,viewColete,viewX, viewParLuvas, viewCapacete, viewGchuva,
            viewMarteloMadeira, viewDocumentos, viewAcendedor, viewCaboF, viewChaveFixa, viewMacaco, viewFmacaco, viewTriangulo;
    EditText camponome, campoExtintor, campoCapaChuva, campoRadio, campoAntena, campoLona, campoColete, campoX,campoParLuvas,
            campoCapacete, campoGchuva, campoMarteloMadeira, campoDocumentos, campoAcendedor, campoCaboF,campoChaveFixa, campoMacaco,
    ...
    public VistoriaTab_CamInterclima_p1() {
        // Required empty public constructor
    }
    // TODO: Rename and change types and number of parameters
    public static VistoriaTab_CamInterclima_p1 newInstance(String param1, String param2) {
        VistoriaTab_CamInterclima_p1 fragment = new VistoriaTab_CamInterclima_p1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate( R.layout.scrollfichacaminhao_p1, container, false);
        ...
        btnAdicionar = vista.findViewById(R.id.btn_Proximo);

        Calendar calendar = Calendar.getInstance();
        String currentDate = DateFormat.getDateInstance().format(calendar.getTime());
        textViewDate = vista.findViewById(R.id.txt_date5);
        ...
        campoChaveFixa = vista.findViewById( R.id.campoChaveFixa );
        ...
        viewChaveFixa = vista.findViewById( R.id.viewChaveFixa );
        ...
        btnAdicionar.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick ( View v ) {
                Intent detailIntent= new Intent(getContext(), VistoriaTab_CamInterclima_p2.class );
                ...
                String ChaveFixa = campoChaveFixa.getText().toString();
                ...
                detailIntent.putExtra("Sixteen",ChaveFixa);
    ...
    private void carregarWEBService() {
        ...
        String url = ip+"/webservice/consultaCaminhao.php?PLACA=" + placaVeiculo.getText().toString();
        url = url.replace( " ", "%20" );
        ...
        jsonObjectReq = new JsonObjectRequest( Request.Method.GET, url, null, new Response.Listener <JSONObject>() {
            ...
            public void onResponse ( JSONObject response ) {
                ...
                JSONArray jsonArray = response.optJSONArray( "fichaCaminhao" );
                ...
                try{
                    ...
                    tabFicha.setChaveFixa( jsonObject.optString("chaveFixa"));
                ...
                viewChaveFixa.setText(tabFicha.getChaveFixa());
