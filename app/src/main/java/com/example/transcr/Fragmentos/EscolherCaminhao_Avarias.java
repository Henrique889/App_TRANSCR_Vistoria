...
import com.example.transcr.Touch_Draw.OlharImagens;
...
public class EscolherCaminhao_Avarias extends Fragment implements Response.Listener<JSONObject>,Response.ErrorListener{
        ...
        public EscolherCaminhao_Avarias () {
            ...
            try{
                ...
                adapter2.setOnItemClickListener( new FrotaAdaptador.OnItemClickListener() {
                    ...
                    public void onItemClick ( int position ) {
                        Intent detailIntent = new Intent(getContext(), OlharImagens.class );
