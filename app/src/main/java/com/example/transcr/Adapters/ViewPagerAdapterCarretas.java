...
public class ViewPagerAdapterCarretas extends PagerAdapter {
    ...
    public ViewPagerAdapterCarretas ( List <SliderUtils> sliderImg, Context context ){
    ...
    public Object instantiateItem (  ViewGroup container, final int position ) {
        ...
        //final EditText placa = (EditText)view.findViewById( R.id.placa6 );
