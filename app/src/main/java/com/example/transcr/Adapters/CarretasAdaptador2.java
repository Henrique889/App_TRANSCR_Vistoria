...
public class CarretasAdaptador2 extends RecyclerView.Adapter<CarretasAdaptador2.CarretasHolder> {
    Context mContext;
    ...
    public CarretasAdaptador2 ( Context mContext, List<Carretas> listaCarretas)    {
    ...
    public CarretasHolder onCreateViewHolder ( @NonNull ViewGroup viewGroup, int i ) {
        ...
        cHolder.item_contact.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick ( View v ) {
                Intent intent = new Intent( mContext, OlharImagensCarretas.class );
