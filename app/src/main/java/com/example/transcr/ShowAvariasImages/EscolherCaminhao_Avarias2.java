...
import com.example.transcr.ShowAvariasImages.Adapters.FrotaAdaptador;
...
public class EscolherCaminhao_Avarias2 extends Fragment implements Response.Listener<JSONObject>,Response.ErrorListener{
        ...
        public EscolherCaminhao_Avarias2 () {
        ...
        public View onCreateView ( @NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState ) {
            ...
            recyclerFrota= vista.findViewById( R.id.idRecycler2 );
        ...
        public void onResponse ( JSONObject response ) {
            ...
            try{
                ...
                FrotaAdaptador adapter2 = new FrotaAdaptador( getContext(), listaFrotas );
                recyclerFrota.setAdapter( adapter2 );
                adapter2.setOnItemClickListener( new FrotaAdaptador.OnItemClickListener() {
                    @Override
                    public void onItemClick ( int position ) {
                        Intent detailIntent = new Intent(getContext(), Ver_TodasAvarias.class );
