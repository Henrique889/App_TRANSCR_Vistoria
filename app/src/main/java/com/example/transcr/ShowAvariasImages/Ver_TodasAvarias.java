...
//Criar um spinner para poder aparecer se o carro está de lado dee frente e deixar o campo PLACA no TOUCHDRAW
public class Ver_TodasAvarias extends AppCompatActivity {
    ViewPager viewPager;
    ...
    public void sendRequest(){
        ...
        request_Url = ip+"/webservice/Pegar_ImagensAvarias.php?name=" + placa.getText().toString();
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest( Request.Method.GET, request_Url, null, new Response.Listener <JSONArray>() {
            ...
            public void onResponse ( JSONArray response ) {
                ...
                viewPagerAdapter = new ViewPagerAdapter( sliderImg, Ver_TodasAvarias.this );
                ...
                for(int i = 0; i < dotscount; i++){
                    ...
                    dots[i] = new ImageView(Ver_TodasAvarias.this);
                    dots[i].setImageDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.twotone_brightness_1_black_18dp));
