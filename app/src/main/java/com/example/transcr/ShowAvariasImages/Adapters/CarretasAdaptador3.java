...
import com.example.transcr.ShowAvariasImages.Ver_TodasAvarias_Carretas;
import com.example.transcr.entidades.Carretas;

import java.util.List;

public class CarretasAdaptador3 extends RecyclerView.Adapter<CarretasAdaptador3.CarretasHolder> {
    Context mContext;
    ...
    public CarretasAdaptador3 ( Context mContext, List<Carretas> listaCarretas)    {
    ...
    public CarretasHolder onCreateViewHolder ( @NonNull ViewGroup viewGroup, int i ) {
        ...
        cHolder.item_contact.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick ( View v ) {
                Intent intent = new Intent( mContext, Ver_TodasAvarias_Carretas.class );
